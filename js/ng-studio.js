...
function jb_run(context,parentParam) {
  ...
  function prepare() {
    ...
    for (var p in comp.params) {
      ...
      val = (typeof(val) != "undefined") ? val : param.defaultValue || [];
      if (!param.ignore) {
        if (param.dynamic)
...
function jb_initJstypes() {
  jbart.jstypes = {
    ...
    'number': function(value) {
      if (jb_isArray(value)) value = value[0];
      if (value == null || value == undefined) return NaN;	// 0 is not null
      value = jb_val(value);
      return Number(value);
    },
...
function jb_dragDialog(dialog) {		// TODO: fix for all browsers
...
if (!window.jbPackaged) {
	...
	[
		...
		"js/styles.js",
		"js/ui.js",
		"js/style-functions.js",
		"js/features.js",
		"js/dialog.js",
		"js/tests.js",
		"js/bootstrap-styles.js",
		"js/tabcontrol.js",
		"js/expandableSection.js",
		"js/editableText.js",
		"js/picklist.js",
		"js/button.js",
		"js/http.js",
		"addon/tree/tree.js",
		"addon/crawler/parsing.js",
		"addon/crawler/crawler.js"
	//	"js/ng-jbart-module.js"
	].
...
if (!window.jbPackaged) {
	...
	[
		...
		"js/studio.js",
		"js/studio-components.js",
		"js/studio-tests.js",
		"js/studio-toolbar.js",
		"js/studio-menu.js",
		"js/studio-properties.js",
		"js/studio-popups.js",
		"js/studio-stringify.js",
		"js/studio-save.js",
		"js/studio-tree.js",
		"js/studio-browse.js",
		"js/studio-select-pt.js",
		"js/studio-undo.js",
		"js/studio-open.js",
		"js/studio-resource.js",
		"js/studio-triplets.js",
		"js/studio-pick.js",
		"js/studio-style-editing.js",
		"js/codemirror-resizer.js",
		"js/probe.js",

		"js/ng/studio-angular.js",
		"js/ng/studio-ng-app.js",
		"js/ng/studio-ng-outline.js",
		"js/ng/studio-ng-templateElem.js",
		"js/ng/studio-ng-popups.js",
		"js/ng/studio-ng-iframe.js",
	...
	forEach(function(file) {
		if (file.substring(file.length-4) == '.css') {
			document.write('<link rel="stylesheet" type="text/css" href="' + (window.jbDevBase || '') + 'studio/' + file + '" />'); 
		} else {
			document.write('<script>jbart.currentFileName = "studio/' + file + '";</script>');
			document.write('<script src="' + (window.jbDevBase || '') + 'studio/' + file + '"></script>');
		}
	});
...
function jbstudio_updateJbartScriptFromCM(newval) {
  ...
  var $sourceDlgTitle = $('.jbart-dialogs').children('.id-edit-source').find('.dialog-title');
		...
		controls: [
			...
			{ $: 'studio.topMenuItem', text: 'Templates',
				controls: [
					{ $: 'dynamicFields', 
						list: function(context) {
							return Object.keys(window.jbNgTemplateDB).splice(0,10);
						},
						variable: 'template',
  		    ...
  		    { $: 'studio.MenuItemSeparator' },
					{ $: 'studio.MenuItem', 
						text: [
							function(context) { return Object.keys(window.jbNgTemplateDB).length; },
						  'Show All Templates ({{}})...'
						],
...
jb_component('studio.openAngularTemplatePopup', {
	...
	impl: {
		...
		style: { $: 'dialog.studioFloating', id: 'edit angular template' },
		content: {
...
jb_component('studio.insertInToolbar', {
	type: 'control',
	impl: function(context) {
		var scope = window.ngService.$rootScope.$new(true);
		...
		scope.insert = function(newTag) {
			...
			var newElem = jbart.studio.previewWindow.document.createElement(newTag);
		...
		var html = jb_getHtmlImport('studio/html/properties.html','.insert-in-toolbar');
		var out = window.ngService.$compile(html)(scope);
		scope.$digest();
		return jb_simpleControl(context,$(out));
	}
});
...
jb_component('studio.angularProperties', {
	...
	impl: function(context,templateElem,_scope) {
		...
		scope.$watch('attributes', function(atts) {
			atts.forEach(function(att) { templateElem.setAttribute(att.name,att.value); });
		},true);
		...
		scope.addDirective = function(newDirective) {
			if (newDirective != '+') {
				...
				scope.newDirective = '+';
				window.ngService.$timeout(function(){
		...
		scope.propertyKeyDown = function($event,addBraces) {
			if ($event.keyCode == 32 && $event.ctrlKey) { // Ctrl+Space
				if (!jbart.studio.autoCompletePopup) {
					jbart.studio.autoCompletePopup = { scope: window.ngService.$rootScope.$new(true) };
					var html = jb_getHtmlImport('studio/html/properties.html','.studio-auto-complete-popup');
					var popup = window.ngService.$compile(html)(jbart.studio.autoCompletePopup.scope);
					$("body").append(popup);
				}
		...
		var html = jb_getHtmlImport('studio/html/properties.html','.studio-properties-in-dialog');
		var out = window.ngService.$compile(html)(scope);
		scope.$digest();
		return jb_simpleControl(context,$(out));
	}
...
function jb_studioAngularPickElem(context,elem) {
	...
	jb_run(jb_ctx(context,{
		data: null,
		profile: [
			{ $: 'studio.openAngularTemplatePopup', elem: '{{$elem}}', templateElem: '{{$templateElem}}' },
		...
		vars: {
			...
			scope: jbart.studio.previewWindow.angular.element(elem).scope()
		}
	}),{ type:'action'});	
}

function jb_getHtmlImport(href, query) {
	var imp = document.querySelector('link[href="'+href+'"]')['import'];
	var content = query ? imp.querySelector(query) : $(imp.body).children();
...
jb_component('studio-ng.outlineContent', {
	...
	impl: function(context) {
		...
		var scope = window.ngService.$rootScope.$new(true);
		scope.templates = Object.keys(window.jbNgTemplateDB);
		...
		var compiled = window.ngService.$compile(html)(scope);
		scope.$digest();
...
jb_component('ng-studio.openShowAllTemplatesPopup', {
	...
	impl: {
		...
		style: { $: 'dialog.studioFloating', id: 'ng-studio templates' },
		content: {
...
jb_component('studio-ng.showTemplates', {
	type: 'control',
	impl: function(context) {
		var html = jb_getHtmlImport('studio/html/templates.html');
		var scope = window.ngService.$rootScope.$new(true);
		scope.templates = Object.keys(window.jbNgTemplateDB);
		scope.openTemplate = function() {
			jb_run(jb_ctx(context, { 
...
jb_component("ng-studio.showTemplate", {
	...
	impl: {
		...
		style: { $: 'dialog.studioFloating', id: 'ng-studio template' },
		$vars: {
